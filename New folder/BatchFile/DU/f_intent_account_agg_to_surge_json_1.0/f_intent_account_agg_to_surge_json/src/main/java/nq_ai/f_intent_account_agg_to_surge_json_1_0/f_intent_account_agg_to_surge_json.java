...
public static class accStruct implements routines.system.IPersistableRow<accStruct> {
    ...
    static byte[] commonByteArray_NQ_AI_f_intent_account_agg_to_surge_json = new byte[0];
			    ...
			    public String FCSTSales__NQ_Account_Name__c;

				public String getFCSTSales__NQ_Account_Name__c () {
					return this.FCSTSales__NQ_Account_Name__c;
				}
		...
		synchronized(commonByteArrayLock_NQ_AI_f_intent_account_agg_to_surge_json) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.FCSTSales__NQ_Account_Name__c = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.FCSTSales__NQ_Account_Name__c,dos);
    ...
    public String toString() {
		...
		sb.append(",FCSTSales__NQ_Account_Name__c="+FCSTSales__NQ_Account_Name__c);
 		                    ...
 		                    class SchemaSettingTool_tSalesforceOutput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"FCSTSales__NQ_Account_Name__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"FCSTSales__NQ_Account_Name__c\",\"talend.field.dbColumnName\":\"FCSTSales__NQ_Account_Name__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"FCSTSales__NQ_Account_Name__c\",\"di.column.relatedEntity\":\"\"},{",s);
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.db_password; 
        	...
        	row1.accountname = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.domain = null;
							} else {
	                         		
        	row1.domain = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.company = null;
							} else {
	                         		
        	row1.company = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.cluster = null;
							} else {
	                         		
        	row1.cluster = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.topic_count = null;
							} else {
		                          
            row1.topic_count = rs_tDBInput_1.getInt(6);
            ...
            row1.avg_surge_score = rs_tDBInput_1.getDouble(7);
            if(rs_tDBInput_1.wasNull()){
                    row1.avg_surge_score = null;
            }
		                    }
        	...
        	row1.topic_data = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.f_intent_account_agg_key = null;
							} else {
	                         		
        	row1.f_intent_account_agg_key = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.nq_external_id = null;
							} else {
	                         		
        	row1.nq_external_id = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.datestamp = null;
							} else {
	                         		
        	row1.datestamp = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.delta_topic_count = null;
							} else {
	                         		
        	row1.delta_topic_count = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.delta_avg_surge_score = null;
							} else {
	                         		
        	row1.delta_avg_surge_score = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
...
acc_tmp.FCSTSales__NQ_Cluster_Type__c = row1.cluster ;
...
acc_tmp.FCSTSales__NQ_Account_Name__c = row1.accountname ;
	...
	currentComponent="tSalesforceOutput_1";
        ...
        if (incomingEnforcer_tSalesforceOutput_1 != null) {
            incomingEnforcer_tSalesforceOutput_1.createNewRecord();
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tSalesforceOutput_1 != null && incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("FCSTSales__NQ_Account_Name__c") != null){
                    incomingEnforcer_tSalesforceOutput_1.put("FCSTSales__NQ_Account_Name__c", acc.FCSTSales__NQ_Account_Name__c);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
...
/************************************************************************************************
 *     179858 characters generated by Talend Open Studio for Big Data 
 *     on the April 18, 2023 at 2:22:10 PM IST
 ************************************************************************************************/